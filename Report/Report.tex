...
%		\caption{The Kurodako Board, although the program only supports six
%		channels for now, the cape has eight mics. (own work)}
%	\end{minipage}%
%	\begin{minipage}{.4\textwidth}
%		\centering
...
%\begin{figure}[H]
%\centering
%\includegraphics[width=0.5\linewidth]{Pictures/kurodako.jpg}
%\caption{The Kurodako Board, although the program only supports six
%channels for now, the cape has eight mics. (own work)}
%\end{figure}
%
