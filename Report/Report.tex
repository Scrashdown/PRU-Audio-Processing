...
\caption{Illustration of a PDM signal.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{Pictures/CIC_structure.png}
...
output pins from the PRUs so that it is possible to read data from the microphones.
...
\texttt{config-pin} command (see these diagrams for more information on which pins can be multiplexed to the PRUs\footnote{Cape headers: \url{http://beagleboard.org/static/images/cape-headers.png}}\footnote{P8 Header Table: \url{https://itbrainpower.net/a-gsm/images/BeagleboneBlackP8HeaderTable.pdf}}\footnote{P9 Header Table: \url{https://itbrainpower.net/a-gsm/images/BeagleboneBlackP9HeaderTable.pdf}}). We still
...
MHz), see the microphone's datasheet for more
