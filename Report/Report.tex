...
Microphone arrays have become increasingly popular due to popular devices such as Amazon Echo, Google Home, etc. These devices make use of microphone arrays to perform algorithms such as beamforming and direction-of-arrival. The LCAV lab at EPFL has already developed such algorithms\footnote{LCAV algorithms repository : \url{https://github.com/LCAV/pyroomacoustics}} and a browser-based interface for audio processing with an embedded platform \footnote{\urlhttps://github.com/LCAV/easy-dsp{}} - the BeagleBone Black. The goal of this project is to implement such a microphone array on the BeagleBone Black, taking advantage of a unique microcontroller available on the BeagleBone Black device - the Programmable Real-time Unit SubSystem (PRUSS).

The project is made of 3 main components :

\begin{itemize}
  \tightlist
  \item The hardware : the microphone array itself, made of the BeagleBone Black and the Kurodako cape\footnote{\url{}}
\end{itemize}
...
The input signals come from 6 Knowles SPM1437HM4H-B microphones\footnote{\url{https://media.digikey.com/pdf/Data\%20Sheets/Knowles\%20Acoustics\%20PDFs/SPM1437HM4H-B.pdf}} connected to the board via a cape designed especially for this project.\footnote{\url{https://github.com/fakufaku/kurodako}}
